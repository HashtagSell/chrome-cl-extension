...
// 		
// 		if(![true, 'edit', 'delete', 'edited'].contains(is_running))
// 		{
...
// 			}
// 		}
// 		else if([true, 'edit', 'delete', 'edited'].contains(is_running))
// 		{
...
// 		
// 		if(
// 			(is_running == true && qs.s == 'type') ||
// 			(['edit', 'delete'].contains(is_running) && !qs.s)
// 		)
// 		{	
...
// 		}
// 
// 		console.log('inject(541).is_running:', is_running);
// 
// 		if(
...
// 		)
// 		{
// 			console.log('setting putActiveURL(false)');
// 			return putActiveURL(false);
// 		}
// 
// 		chrome.runtime.sendMessage(
// 			{ 
// 				'cmd' : 'getListingMeta',
// 				'step' : (qs.s) ? qs.s : new Date().getTime()
// 			},
// 			function(response)
// 			{
